...
//we have assigned physics body categories
...
extension GameScene
{
//KUŞ OLUŞTURMA VE ÖZELLİKLERİ AYARI
...
//    func random() -> CGPDFInteger
//    {
//        return CGPDFInteger(Int(arc4random()) / 0xFFFFFFFF)
//    }
//    func random(min : CGPDFInteger, max : CGPDFInteger) -> CGPDFInteger
//    {
//        return random() * (max - min) + min
//    }
